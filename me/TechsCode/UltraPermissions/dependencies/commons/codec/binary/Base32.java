...
public class Base32 extends BaseNCodec
{
    ...
    public Base32(final int i, final byte[] array, final boolean b, final byte b2) {
        super(5, 8, i, (array == null) ? 0 : array.length, b2);
        if (b) {
        ...
        if (this.isInAlphabet(b2) || BaseNCodec.isWhiteSpace(b2)) {
