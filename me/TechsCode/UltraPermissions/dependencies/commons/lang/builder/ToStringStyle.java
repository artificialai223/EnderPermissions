...
public abstract class ToStringStyle implements Serializable
{
    ...
    static void register(final Object o) {
        if (o != null) {
            Map<Object, Object> registry = (Map<Object, Object>)getRegistry();
            if (registry == null) {
                registry = new WeakHashMap<Object, Object>();
                ToStringStyle.REGISTRY.set(registry);
            }
            registry.put(o, null);
        }
    }
    ...
    public void appendToString(final StringBuffer sb, final String s) {
        if (s != null) {
            final int beginIndex = s.indexOf(this.contentStart) + this.contentStart.length();
            final int lastIndex = s.lastIndexOf(this.contentEnd);
            if (beginIndex != lastIndex && beginIndex >= 0 && lastIndex >= 0) {
                final String substring = s.substring(beginIndex, lastIndex);
    ...
    protected void setShortClassName(final boolean useShortClassName) {
        this.useShortClassName = useShortClassName;
    }
